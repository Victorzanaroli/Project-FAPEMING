...
1. Desenvolver o Pensamento Computacional dos estudantes por meio da prática guiada com Python e IA generativa.
2. Capacitar os alunos a criar aplicativos mobile funcionais usando Python + Flet no Pydroid 3 e VS Code.
3. Promover o letramento em Inteligência Artificial, ensinando engenharia de prompt e uso crítico e ético de IA.
4. Coletar dados para pesquisa acadêmica sobre o impacto da IA no processo de aprendizagem (T0 e T1).
5. Desenvolver soft skills de apresentação, trabalho em equipe e resolução de problemas vinculados aos ODS.
...
## 📌 Observações para o Gestor / Congresso

Este plano didático integra três dimensões formativas simultaneamente:
